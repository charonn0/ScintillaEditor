...
Inherits Scintilla.Managers.BaseManager
	...
	#tag Method, Flags = &h0
		Function FindInDocument(SearchPattern As String, Start As Integer = 0, Finish As Integer = - 1) As Integer
		  ...
		  Dim mb As New MemoryBlock(SearchPattern.LenB * 2)
		  mb.CString(0) = SearchPattern
		  ttf.SearchPattern = mb
		  ttf.Range.cpMin = Start
		  ttf.Range.cpMax = Finish
		  If Me.SendMessage(Scintilla.SCI.FINDTEXT, Me.Flags, ttf) = -1 Then Raise New Scintilla.ScintillaException(GetLastError, False)
